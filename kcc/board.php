<?php
    ...
    $stmh = $pdo->prepare($sql);//query보다 보안성이 좋음.
    $stmh->execute();//stmh를 실행해준다.
    $result = $stmh->fetchAll();//fetch는 for/while문이 필요하고(반복문) fetchAll은 foreach문이 필요하다.
//    echo '<pre>';
//    print_r($result);
?>
<!DOCTYPE html>
<html lang="ko">
    <a href="ex/day1/board.php"></a>
<head>
<meta charset="utf-8">
